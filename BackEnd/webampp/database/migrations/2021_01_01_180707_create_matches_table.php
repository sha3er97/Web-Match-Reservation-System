...
class CreateMatchesTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('matches', function (Blueprint $table) {
            ...
            //$table->foreign('home')->references('number')->on('teams')->onUpdate('cascade')->onDelete('cascade');
            //$table->foreign('away')->references('number')->on('teams')->onUpdate('cascade')->onDelete('cascade');
